...
VideoAgent = LlmAgent(
    ...
    instruction="""
    You are an agent that creates a video for a social media reel. Use the 'get_stickers_tool' to fetch character stickers, 'video_editing_tool' to compose the video, and 'add_subtitles_tool' to overlay subtitles. Accept all required parameters and return the final video path.
    """,
